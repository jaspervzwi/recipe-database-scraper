...
@pytest.mark.util
@pytest.mark.parametrize("url,expected_homepage", [
    ("http://www.example.com/page.html", "http://www.example.com/"),
    ("https://example.com", "https://example.com/"),
    ("http://subdomain.example.com/resource?query=param", "http://subdomain.example.com/"),
    ...
    ("https://example.com/path/to/resource?query=param#fragment", "https://example.com/"),
    ("https://www.example.edu/about", "https://www.example.edu/"),
    ("http://example.net/contact", "http://example.net/"),
    ("https://another.subdomain.example.co.uk/page.html", "https://another.subdomain.example.co.uk/"),
